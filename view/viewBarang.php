            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="fit">
                        ...
                        <a class="badge bg-danger" href="<?=BASEURL?>/admin/deleteBarang.php?nama=<?=urlencode($row['nama'])?>&resi=<?=urlencode($row['resi']) ?>" onclick="return confirm('Are you sure?');">Delete</a>
