            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="fit">
                        ...
                        <a class="badge bg-danger" href="<?=BASEURL?>/deleteRiwayatPengiriman.php?resi=<?=urlencode($row['resi'])?>&id_status=<?=urlencode($row['ID_status']) ?>" onclick="return confirm('Are you sure?');">Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
